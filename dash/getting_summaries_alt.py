...
def get_summary_volume(self):
    ...
    print ("PRESURE!!")
    print ("INDEX")
    print (np.min(self.df_subsystem_pressure.Target_P[self.df_subsystem_pressure.Target_P.astype(float) > 400].index))
    print (self.df_subsystem_pressure.Target_P.astype(float)[0:np.min(self.df_subsystem_pressure.Target_P[self.df_subsystem_pressure.Target_P.astype(float) > 400].index)])

...
def get_subsystems_dataframe_source(self):
    ...
    source_voltage,source_current,gas_flow = saving_files_summary_list_20200420.get_source_parameters(self.file_df,self.max_current)
...
def get_subsystems_dataframe_vacuum(self):
    ...
    vacuum_level = saving_files_summary_list_20200420.get_vacuum_parameters(self.file_df,self.max_current)
    magnet_current = saving_files_summary_list_20200420.get_magnet_parameters(self.file_df,self.max_current)
...
def get_subsystems_dataframe_magnet(self):    
    ...
    self.magnet_current = saving_files_summary_list_20200420.get_magnet_parameters(self.file_df,self.max_current)
...
def get_subsystems_dataframe_rf(self):
    ...
    dee1_voltage,dee2_voltage = saving_files_summary_list_20200420.get_rf_parameters(self.file_df,self.max_current) 
    forwarded_power,reflected_power,phase_load = saving_files_summary_list_20200420.get_rf_parameters_power(self.file_df,self.max_current)
    flap1_pos,flap2_pos = saving_files_summary_list_20200420.get_rf_parameters_flaps(self.file_df,self.max_current)
...
def get_subsystems_dataframe_rf_sparks(self):
    ...
    dee1_voltage,dee2_voltage = saving_files_summary_list_20200420.get_rf_parameters_sparks(self.file_df,self.max_current) 
    forwarded_power,reflected_power,phase_load = saving_files_summary_list_20200420.get_rf_parameters_power_sparks(self.file_df,self.max_current)
    flap1_pos,flap2_pos = saving_files_summary_list_20200420.get_rf_parameters_flaps_sparks(self.file_df,self.max_current)
...
def get_subsystems_dataframe_extraction(self):
    ...
    carousel_position,balance_position = saving_files_summary_list_20200420.get_extraction_parameters_position(self.file_df,self.max_current)
...
def get_subsystems_dataframe_beam(self):
    ...
    collimator_r,collimator_l = saving_files_summary_list_20200420.get_collimator_parameters(self.file_df,self.max_current) 
    extraction_current = saving_files_summary_list_20200420.get_extraction_parameters(self.file_df,self.max_current)
...
def get_subsystems_dataframe_pressure(self):
    ...
    target_pressure = saving_files_summary_list_20200420.get_target_pressure(self.file_df,self.max_current)

...
def main_menu(self):
        ...
        self.editorMenu = self.mainMenu.addMenu('&Plot Individual Files')
...
def adding_plot_actions(self):
        self.editorMenu.addAction(self.openPlotI)
        self.editorMenu.addAction(self.openPlotIV)
        self.editorMenu.addAction(self.openPlotM)
        self.editorMenu.addAction(self.openPlotRF)
        self.editorMenu.addAction(self.openPlotRFPower)
        self.editorMenu.addAction(self.openPlotEx)
        self.editorMenu.addAction(self.openPlotColTarget)

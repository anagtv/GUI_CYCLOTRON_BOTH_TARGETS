...
def get_year_results(date_week,date_week_unique,file_df,column,target):
    ...
    if file_df.TARGET[index_total[i]] == target:
        file_source_year.append(file_df[column][index_total[i]])
...
def main():
    ...
    #all_paths = ["/Users/anagtv/Documents/OneDrive/Ana_GTV_Compartida/Mantenimientos_ciclotrones/JNS/Analysis_JNS_20200921/","/Users/anagtv/Documents/OneDrive/Ana_GTV_Compartida/Mantenimientos_ciclotrones/JNS/Analysis_logs_2019"
    #,"/Users/anagtv/Documents/OneDrive/Ana_GTV_Compartida/Mantenimientos_ciclotrones/JNS/Analysis_logs_2018","/Users/anagtv/Documents/OneDrive/Ana_GTV_Compartida/Mantenimientos_ciclotrones/JNS/Analysis_logs_2017"]
    all_paths = ["/Users/anagtv/Documents/OneDrive/Ana_GTV_Compartida/Mantenimientos_ciclotrones/JNS/Logs_october_analysis"]
    ...
    for path_year in all_paths:
         ...
         print ("DATE WEEK")
         print (date_week,date_week_unique)
         #source
         file_source_weeks_1 = get_all_values(date_week,date_week_unique,file_source,"CURRENT_AVE","1")
         file_source_weeks_4 = get_all_values(date_week,date_week_unique,file_source,"CURRENT_AVE","4")
         [file_source_average_1,file_source_weeks_std_1] = get_average_weekly_values(file_source_weeks_1)
         [file_source_average_4,file_source_weeks_std_4] = get_average_weekly_values(file_source_weeks_4)
         ...
         [file_source_foil_average_1,file_source_foil_std_1] = get_average_weekly_values(file_foils_1)
         [file_source_foil_average_4,file_source_foil_std_4] = get_average_weekly_values(file_foils_4)
         file_source_foil_average_1_all.append(file_source_foil_average_1)
         file_source_foil_std_1_all.append(file_source_foil_std_1)
         file_source_foil_average_4_all.append(file_source_foil_average_4)
         file_source_foil_std_4_all.append(file_source_foil_std_4)
         # source current latex
         print ("COLL L (RELATIVE)")
         file_col_l_relative_weeks_1 = get_all_values(date_week,date_week_unique,file_beam,"RELATIVE_COLL_CURRENT_L_AVE","1")
         file_col_l_relative_weeks_4 = get_all_values(date_week,date_week_unique,file_beam,"RELATIVE_COLL_CURRENT_L_AVE","4")
         [file_col_l_relative_average_1,file_col_l_relative_weeks_std_1] = get_average_weekly_values(file_col_l_relative_weeks_1)
         [file_col_l_relative_average_4,file_col_l_relative_weeks_std_4] = get_average_weekly_values(file_col_l_relative_weeks_4)
         ...
         #source performance
         file_source_performance_weeks_1 = get_all_values(date_week,date_week_unique,file_source,"SOURCE_PERFORMANCE","1")
         file_source_performance_weeks_4 = get_all_values(date_week,date_week_unique,file_source,"SOURCE_PERFORMANCE","4")
         [file_source_performance_average_1,file_source_performance_weeks_std_1] = get_average_weekly_values(file_source_performance_weeks_1)
         [file_source_performance_average_4,file_source_performance_weeks_std_4] = get_average_weekly_values(file_source_performance_weeks_4)
         ...
         #vacuum
         file_vacuum_weeks_1 = get_all_values(date_week,date_week_unique,file_vacuum,"PRESSURE_AVE","1")
         file_vacuum_weeks_4 = get_all_values(date_week,date_week_unique,file_vacuum,"PRESSURE_AVE","4")
         [file_vacuum_average_1,file_vacuum_weeks_std_1] = get_average_weekly_values(file_vacuum_weeks_1)
         [file_vacuum_average_4,file_vacuum_weeks_std_4] = get_average_weekly_values(file_vacuum_weeks_4)
         ...
         #magnet 
         print ("MAGNET")
         file_magnet_weeks_1 = get_all_values(date_week,date_week_unique,file_magnet,"CURRENT_AVE","1")
         file_magnet_weeks_4 = get_all_values(date_week,date_week_unique,file_magnet,"CURRENT_AVE","4")
         [file_magnet_average_1,file_magnet_weeks_std_1] = get_average_weekly_values(file_magnet_weeks_1)
         [file_magnet_average_4,file_magnet_weeks_std_4] = get_average_weekly_values(file_magnet_weeks_4)
         ...
         #extraction
         print ("CAROUSSEL")
         file_caroussel_weeks_1 = get_all_values(date_week,date_week_unique,file_extraction,"CAROUSEL_POSITION_AVE","1")
         file_caroussel_weeks_4 = get_all_values(date_week,date_week_unique,file_extraction,"CAROUSEL_POSITION_AVE","4")
         [file_caroussel_average_1,file_caroussel_weeks_std_1] = get_average_weekly_values(file_caroussel_weeks_1)
         [file_caroussel_average_4,file_caroussel_weeks_std_4] = get_average_weekly_values(file_caroussel_weeks_4)
         ...
         print ("BALANCE")
         file_balance_weeks_1 = get_all_values(date_week,date_week_unique,file_extraction,"BALANCE_POSITION_AVE","1")
         file_balance_weeks_4 = get_all_values(date_week,date_week_unique,file_extraction,"BALANCE_POSITION_AVE","4") 
         [file_balance_average_1,file_balance_weeks_std_1] = get_average_weekly_values(file_balance_weeks_1)
         [file_balance_average_4,file_balance_weeks_std_4] = get_average_weekly_values(file_balance_weeks_4)
         ...
         #rf
         print ("RF (DEE 1)")
         file_dee1_weeks_1 = get_all_values(date_week,date_week_unique,file_rf,"DEE1_VOLTAGE_AVE","1")
         file_dee1_weeks_4 = get_all_values(date_week,date_week_unique,file_rf,"DEE1_VOLTAGE_AVE","4")
         [file_dee1_average_1,file_dee1_weeks_std_1] = get_average_weekly_values(file_dee1_weeks_1)
         [file_dee1_average_4,file_dee1_weeks_std_4] = get_average_weekly_values(file_dee1_weeks_4)
         ...
         print ("RF (DEE 2)")
         file_dee2_weeks_1 = get_all_values(date_week,date_week_unique,file_rf,"DEE2_VOLTAGE_AVE","1")
         file_dee2_weeks_4 = get_all_values(date_week,date_week_unique,file_rf,"DEE2_VOLTAGE_AVE","4") 
         [file_dee2_average_1,file_dee2_weeks_std_1] = get_average_weekly_values(file_dee2_weeks_1)
         [file_dee2_average_4,file_dee2_weeks_std_4] = get_average_weekly_values(file_dee2_weeks_4)
         ...
         print ("RF FORWARD")
         file_forward_weeks_1 = get_all_values(date_week,date_week_unique,file_rf,"FORWARD_POWER_AVE","1")
         file_forward_weeks_4 = get_all_values(date_week,date_week_unique,file_rf,"FORWARD_POWER_AVE","4")
         [file_forward_average_1,file_forward_weeks_std_1] = get_average_weekly_values(file_forward_weeks_1)
         [file_forward_average_4,file_forward_weeks_std_4] = get_average_weekly_values(file_forward_weeks_4)
         ...
         print ("RF REFLECTED")
         file_reflected_weeks_1 = get_all_values(date_week,date_week_unique,file_rf,"REFLECTED_POWER_AVE","1")
         file_reflected_weeks_4 = get_all_values(date_week,date_week_unique,file_rf,"REFLECTED_POWER_AVE","4") 
         [file_reflected_average_1,file_reflected_weeks_std_1] = get_average_weekly_values(file_reflected_weeks_1)
         [file_reflected_average_4,file_reflected_weeks_std_4] = get_average_weekly_values(file_reflected_weeks_4)
         ...
         print ("RF FLAP 1")
         file_flap_1_weeks_1 = get_all_values(date_week,date_week_unique,file_rf,"FLAP1_AVE","1")
         file_flap_1_weeks_4 = get_all_values(date_week,date_week_unique,file_rf,"FLAP1_AVE","4") 
         [file_flap_1_average_1,file_flap_1_weeks_std_1] = get_average_weekly_values(file_flap_1_weeks_1)
         [file_flap_1_average_4,file_flap_1_weeks_std_4] = get_average_weekly_values(file_flap_1_weeks_4)
         ...
         print ("RF FLAP 2")
         file_flap_2_weeks_1 = get_all_values(date_week,date_week_unique,file_rf,"FLAP2_AVE","1")
         file_flap_2_weeks_4 = get_all_values(date_week,date_week_unique,file_rf,"FLAP2_AVE","4") 
         [file_flap_2_average_1,file_flap_2_weeks_std_1] = get_average_weekly_values(file_flap_2_weeks_1)
         [file_flap_2_average_4,file_flap_2_weeks_std_4] = get_average_weekly_values(file_flap_2_weeks_4)
         ...
         print (date_week)
         print (date_week_unique)
         file_col_l_weeks_1 = get_all_values(date_week,date_week_unique,file_beam,"COLL_CURRENT_L_AVE","1")
         file_col_l_weeks_4 = get_all_values(date_week,date_week_unique,file_beam,"COLL_CURRENT_L_AVE","4")
         [file_col_l_average_1,file_col_l_weeks_std_1] = get_average_weekly_values(file_col_l_weeks_1)
         [file_col_l_average_4,file_col_l_weeks_std_4] = get_average_weekly_values(file_col_l_weeks_4)
         ...
         print ("COLL R")
         file_col_r_weeks_1 = get_all_values(date_week,date_week_unique,file_beam,"COLL_CURRENT_R_AVE","1")
         file_col_r_weeks_4 = get_all_values(date_week,date_week_unique,file_beam,"COLL_CURRENT_R_AVE","4") 
         [file_col_r_average_1,file_col_r_weeks_std_1] = get_average_weekly_values(file_col_r_weeks_1)
         [file_col_r_average_4,file_col_r_weeks_std_4] = get_average_weekly_values(file_col_r_weeks_4)
         ...
         file_col_r_relative_weeks_1 = get_all_values(date_week,date_week_unique,file_beam,"RELATIVE_COLL_CURRENT_R_AVE","1")
         file_col_r_relative_weeks_4 = get_all_values(date_week,date_week_unique,file_beam,"RELATIVE_COLL_CURRENT_R_AVE","4") 
         [file_col_r_relative_average_1,file_col_r_relative_weeks_std_1] = get_average_weekly_values(file_col_r_relative_weeks_1)
         [file_col_r_relative_average_4,file_col_r_relative_weeks_std_4] = get_average_weekly_values(file_col_r_relative_weeks_4)
         ...
         print ("TARGET")
         file_target_weeks_1 = get_all_values(date_week,date_week_unique,file_beam,"TARGET_CURRENT_AVE","1")
         file_target_weeks_4 = get_all_values(date_week,date_week_unique,file_beam,"TARGET_CURRENT_AVE","4")
         [file_target_average_1,file_target_weeks_std_1] = get_average_weekly_values(file_target_weeks_1)
         [file_target_average_4,file_target_weeks_std_4] = get_average_weekly_values(file_target_weeks_4)
         ...
         print ("FOIL")
         file_foil_weeks_1 = get_all_values(date_week,date_week_unique,file_beam,"FOIL_CURRENT_AVE","1")
         file_foil_weeks_4 = (date_week,date_week_unique,file_source,"FOIL_CURRENT_AVE","4")
         [file_foil_average_1,file_foil_weeks_std_1] = get_average_weekly_values(file_target_weeks_1)
         [file_foil_average_4,file_foil_weeks_std_4] = get_average_weekly_values(file_target_weeks_4)
         ...
         print ("LOSSES")
         file_extraction_weeks_1 = get_all_values(date_week,date_week_unique,file_beam,"EXTRACTION_LOSSES_AVE","1")
         file_extraction_weeks_4 = get_all_values(date_week,date_week_unique,file_beam,"EXTRACTION_LOSSES_AVE","4")
         [file_extraction_average_1,file_extraction_weeks_std_1] = get_average_weekly_values(file_extraction_weeks_1)
         [file_extraction_average_4,file_extraction_weeks_std_4] = get_average_weekly_values(file_extraction_weeks_4)
         ...
         print ("AVERAGE")
         print (file_extraction_average_1)
         print (file_extraction_average_4)
